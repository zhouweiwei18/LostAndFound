...
public class Message {
	...
	public String toString() {
		return "Message [messageId=" + messageId + ", messageDescription=" + messageDescription + ", messageUserid="
				+ messageUserid + ", messageCategotyid=" + messageCategotyid + ", messageDate=" + messageDate
